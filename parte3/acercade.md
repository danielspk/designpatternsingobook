...
Semánticamente la aplicación del patrón es correcta. El contexto es el _Transportista_ y las estrategias son las _Empresas_. Sin embargo esta implementación es exclusivamente semantica, porque el lenguaje:

* no tiene forma de validar que lo que se este pasando al _Transportista_ séa una _Estrategia_ válida.
