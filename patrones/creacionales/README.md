...
Esta definición de Gamma es un desafio de representar en _Go_ ya que como hemos visto no existen ni las *clases*, ni sus *instancias*, ni los *objetos* y ni la *herencia de clase*. Sin embargo veremos como todo encaja en su lugar en cada patrón y cómo pueden implementarse en _Go_.
